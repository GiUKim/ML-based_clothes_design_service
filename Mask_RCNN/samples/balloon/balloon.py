...
ROOT_DIR = os.path.abspath("/content/gdrive/MyDrive/Mask_RCNN")
...
class DeepFashion2Config(Config):
    ...
    train_img_dir = "/content/gdrive/MyDrive/Mask_RCNN/datasets/image"
    train_json_path = "/content/gdrive/MyDrive/Mask_RCNN/datasets/deepfashion2.json"
